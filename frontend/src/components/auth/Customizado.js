                    ...
                    <div className="form-group col-sm-12">
                        <table className="table table-hover table-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">Gestión de categoría de máquinas</th>
                                    <td>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" name="visualizarCategoriaMaquina" defaultChecked={permisos.visualizarCategoriaMaquina ? true : false}/>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" name="crearCategoriaMaquina" defaultChecked={permisos.crearCategoriaMaquina ? true : false}/>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" name="editarCategoriaMaquina" defaultChecked={permisos.editarCategoriaMaquina ? true : false}/>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" name="eliminarCategoriaMaquina" defaultChecked={permisos.eliminarCategoriaMaquina ? true : false}/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th scope="row">Gestión de sucursales</th>
                                    <td>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" name="visualizarSucursal" defaultChecked={permisos.visualizarSucursal ? true : false}/>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" name="crearSucursal" defaultChecked={permisos.crearSucursal ? true : false}/>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" name="editarSucursal" defaultChecked={permisos.editarSucursal ? true : false}/>
                                        </div>
                                    </td>
                                    <td>
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" name="eliminarSucursal" defaultChecked={permisos.eliminarSucursal ? true : false}/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
