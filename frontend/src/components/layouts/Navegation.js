    ...
    render() {
        ...
        const liPersonas = (
            <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    {muestraCliente && <NavLink className="dropdown-item" to="/clientes">Clientes</NavLink>}
                    {muestraProveedor && <NavLink className="dropdown-item" to="/proveedores">Proveedores</NavLink>}
                </div>
            </li>
        )
